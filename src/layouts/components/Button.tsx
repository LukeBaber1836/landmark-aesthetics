      ...
      {enable &&
        (link ? (
          <Link
            ...
            className={`btn ${className} relative overflow-hidden inline-block group hover:shadow-lg hover:shadow-black/50 transition-shadow duration-300 ease-in-out hover:cursor-pointer ${isLoading ? "pointer-events-none" : ""}`}
          >
